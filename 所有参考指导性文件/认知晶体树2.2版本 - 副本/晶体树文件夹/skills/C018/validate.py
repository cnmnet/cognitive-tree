...
# -*- coding: utf-8 -*-
"""
C018 validation script
Auto-generated during crystal migration

Crystal content: B2B决策链的“核心-外围”张力...
"""
...
def test_input_conditions():
    ...
    if "分析B2B客户决策时" not in str(input_data): print(f"  WARN: missing input condition: 分析B2B客户决策时")
    if "涉及多方角色时" not in str(input_data): print(f"  WARN: missing input condition: 涉及多方角色时")
    if "需要设计销售策略时" not in str(input_data): print(f"  WARN: missing input condition: 需要设计销售策略时")
...
def test_validation_criteria():
    """验证所有验证标准"""
    print("  criteria 1: 策略被销售团队采纳")
    print("  criteria 2: 客户决策周期缩短")
    print("  criteria 3: 核心决策者认可度提升")
    print("[PASS] validation_criteria")


def main():
    """Run all validation tests"""
    print(f"Validating crystal C018...")
    print("-" * 50)
