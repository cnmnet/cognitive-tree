...
# -*- coding: utf-8 -*-
"""
C022 validation script
Auto-generated during crystal migration

Crystal content: “接口思维”优于“管控思维”...
"""
...
def test_input_conditions():
    ...
    if "需要设计系统或接口时" not in str(input_data): print(f"  WARN: missing input condition: 需要设计系统或接口时")
    if "团队协作出现职责冲突时" not in str(input_data): print(f"  WARN: missing input condition: 团队协作出现职责冲突时")
    if "评估技术方案时" not in str(input_data): print(f"  WARN: missing input condition: 评估技术方案时")
...
def test_validation_criteria():
    """验证所有验证标准"""
    print("  criteria 1: 接口定义清晰无歧义")
    print("  criteria 2: 协作效率提升")
    print("  criteria 3: 冲突减少")
    print("[PASS] validation_criteria")


def main():
    """Run all validation tests"""
    print(f"Validating crystal C022...")
    print("-" * 50)
