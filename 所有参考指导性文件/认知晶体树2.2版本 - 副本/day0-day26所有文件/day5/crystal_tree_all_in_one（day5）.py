...
"""
    ...
    # ========================================================================
    # 替换 DebateEngine.run() 及补全 _run_lark_bare
    # ========================================================================
    ...
    def run(self, question: str, mode: str = "debate_full", max_rounds: int = 4) -> Dict:
        ...
        lark_bare_answer = self._run_lark_bare(question)
        ...
        round1_answers = self._independent_round(question, shared_context, core_roles, baseline_answer=lark_bare_answer)
